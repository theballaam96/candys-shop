...
- There are a couple ways to submit your song:
    ...
    - **Directly from Github**: The second way is to create your own Github Fork and add your Binary, and MP3 Files (Don't submit MP3 if you plan on using a Youtube link instead). You then want to make a Pull Request with your files into `theballaam96:main` branch. In your PR you then want to add this comment:
        ```IS SONG - DO NOT DELETE THIS LINE
        Game: Insert Game Name Here
        Song: Insert Song Name Here
        Composers: Insert Composer(s) Here
        Converters: Insert Your Discord Name Here
        Category: bgm, event, Major Item, or Minor Item (Choose one)
        Audio: Insert Link to MP3 (Can be Google Drive link or Youtube Link)
        Update Notes: Add if applicable
        Tags: Choose up to 3 Tags (Fights, Lobbies and Shops, Interiors, Exteriors, Minigames, Spawning, Collection, Happy, Gloomy, or Calm)```
